		...
		<div className="bg-rq-gray-300 relative mt-6 overflow-hidden">
			...
			<div className="absolute top-0 left-0 w-full h-full flex items-center">
				<Container className="flex flex-col items-end">
					<div
						className="text-left"
						style={{ maxWidth: '617px', width: '100%' }}
					>
						<h2 className="text-4xl 2xl:text-5xl 2xl:leading-tight font-bold mb-7">
