...
For example, if you hit *Enter,* you will add a new block under your paragraph block. Nonetheless, this  time, you can try adding an image block by using that very same *Plus* sign:
