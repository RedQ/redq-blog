...
<iframe src="https://www.youtube.com/embed/-KEtlrExZcc" width="900" height="550" frameborder="0" allowfullscreen="allowfullscreen"><span data-mce-type="bookmark" style="display: inline-block; width: 0px; overflow: hidden; line-height: 0;" class="mce_SELRES_start">﻿</span></iframe>

## To create a plan, at first, we have to go to the admin menu UserPlace -> Membership Plan

![](/assets/blog/images/u41.png)
...
![](/assets/blog/images/u45.png)

##### **Plan restriction**

![](/assets/blog/images/u47.png)
...
<iframe src="https://www.youtube.com/embed/PQd5F3JBOoU?list=PLUT1MYLrVpA-XvgbctgajnKWW1fFPAD0A" width="854" height="480" frameborder="0" allowfullscreen="allowfullscreen"></iframe>

To create a stripe plan you need to login to stripe dashboard first. Then navigate to Billing -> Product

![](/assets/blog/images/u51.png)

Then, add a new product.

![](/assets/blog/images/u56.png)

This you will be redirected to the page with below info

![](/assets/blog/images/u52.png)

![](/assets/blog/images/u57.png)

Now click the pointed area and then you will be redirected to a new page with plan id and more details

![](/assets/blog/images/u54.png)
...
![](/assets/blog/images/u71.png)

\[ushop_button_shortcode_blog_wrap btn_align="text-center"\] \[ushop_button_shortcode_blog btn_class="visit-btn" btn_text="Visit site" btn_url="https://redq.io/userplace"\] \[/ushop_button_shortcode_blog_wrap\]
